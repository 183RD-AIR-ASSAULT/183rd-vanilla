class OETAV_ModuleSafeZone: Module_F {
    scope = 2;
    displayName = "Safe Zone";
    icon = "\z\oetav\addons\common\images\icons\Safe_Zone.paa";
    category = QUOTE(PREFIX);
    function = "oetav_fnc_moduleSafeZone";
    functionPriority = 4;
    isGlobal = 0;
    ...
    class Attributes: AttributesBase {
        ...
        class SafeZoneDuration: Edit {
                property = "oetav_SafeZoneDuration";
