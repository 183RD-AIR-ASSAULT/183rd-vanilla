 ...
 * \oetav_medical\supplies\functions\fn_doUnpackMedicKit.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player] call OETAV_medical_supplies_fnc_doUnpackMedicKit;
 *
 */
...
[_unit] spawn {
    ...
    [
        2,
        [], { OETAV_MEDICAL_SUPPLIES_UNPACK_SUCCESS = true; }, { OETAV_MEDICAL_SUPPLIES_UNPACK_FAILURE = true; },
 ...
 {true},
    ...
    if (OETAV_MEDICAL_SUPPLIES_UNPACK_SUCCESS) exitWith {
        ...
        _unit removeItem "OETAV_medbags_MedicKit";
