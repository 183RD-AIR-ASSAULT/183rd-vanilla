...
/*
    ...
    class GVAR(kitbag_khaki_independent): oetav_TFAR_anprc155_kitbag {
    ...
    class GVAR(kitbag_coyote_independent): oetav_TFAR_anprc155_kitbag {
    ...
    class GVAR(kitbag_winter_independent): oetav_TFAR_anprc155_kitbag {
    ...
    class GVAR(kitbag_black_independent): oetav_TFAR_anprc155_kitbag {
    ...
    class GVAR(ilbe_marpatwd_east): oetav_TFAR_mr6000l_ilbe {
    ...
    class GVAR(ilbe_marpatd_east): oetav_TFAR_mr6000l_ilbe {
    ...
    class GVAR(ilbe_coyote_east): oetav_TFAR_mr6000l_ilbe {
    ...
    class GVAR(ilbe_khaki_east): oetav_TFAR_mr6000l_ilbe {
    ...
    class GVAR(ilbe_marpatwd_west): oetav_TFAR_anarc210_ilbe {
    ...
    class GVAR(ilbe_marpatd_west): oetav_TFAR_anarc210_ilbe {
    ...
    class GVAR(ilbe_coyote_west): oetav_TFAR_anarc210_ilbe {
    ...
    class GVAR(ilbe_khaki_west): oetav_TFAR_anarc210_ilbe {
    ...
    class GVAR(ilbe_marpatwd_independent): oetav_TFAR_anarc164_ilbe {
    ...
    class GVAR(ilbe_marpatd_independent): oetav_TFAR_anarc164_ilbe {
    ...
    class GVAR(ilbe_coyote_independent): oetav_TFAR_anarc164_ilbe {
    ...
    class GVAR(ilbe_khaki_independent): oetav_TFAR_anarc164_ilbe {
