            ...
            class PREFIX {
                ...
                class Attributes {
                    class GVAR(Arsenal_Select) {
                        property = QUOTE(OETAV_Arsenal_Select);
                        ...
                        expression = "if (_value > -1) then {[_this, _value] call OETAV_fnc_FullArsenal;}";
                        typeName = "STRING";
                        condition = "objectHasInventoryCargo - objectVehicle";
                        defaultValue = "-1";
                    };
                        class GVAR(Ammo_Select) {
                        property = QUOTE(OETAV_Ammo_Select);
                        control = "ArsenalSelect";
                        ...
                        expression = "if (_value > -1) then {[_this, _value] call OETAV_fnc_LimitedArsenal;}";
                        typeName = "STRING";
                        condition = "objectHasInventoryCargo - objectVehicle";
                        defaultValue = "-1";
                    };
                        class GVAR(LimitedAmmoSelect) {
                        property = QUOTE(OETAV_LimitedAmmoSelect);
                        ...
                        property = QUOTE(OETAV_Equipment_Select);
