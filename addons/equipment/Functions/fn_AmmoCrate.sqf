/*
Function name:OETAV_fnc_OETAV_fnc_AmmoCrate;
Author: Mr H.
...
Example(s):
[this,10,true,true] call OETAV_fnc_AmmoCrate;
*/
...
_box setVariable ["OETAV_AmmoMagazines", _allMagazinesType];

_handlerIndex = _box addEventHandler
 ["ContainerOpened",
  {
  _box = _this select 0;
  _allMagazinesType = _box getVariable "OETAV_AmmoMagazines";



  clearMagazineCargoGlobal _box;
  {_box addMagazineCargoGlobal [_x,10];} forEach _allMagazinesType;
        _box addItemCargoGlobal ["OETAV_medbags_FirstAid",1];
        _box addItemCargoGlobal ["OETAV_medbags_MedicKit",1];
        _box addItemCargoGlobal ["OETAV_mopp",1];
  _box addItemCargoGlobal ["HandGrenade",8];
  _box addItemCargoGlobal ["SmokeShell",8];
  _box addItemCargoGlobal ["ACE_M84",8];
  }
 ];
_box setVariable ["OETAV_AmmoCrateEHIndex", _handlerIndex, true];
...
_box setVariable ["OETAV_AmmoCrateParameters", _params, true];
...
_statement =
 ...
 _box = _this select 0;
 _params = _box getVariable "OETAV_AmmoCrateParameters";
 [[_params],
  {
  params ["_params"];
  _box = _params select 0;
  _handlerIndex = _box getVariable "OETAV_AmmoCrateEHIndex";
  ...
  _params call OETAV_fnc_AmmoCrate;
  }
