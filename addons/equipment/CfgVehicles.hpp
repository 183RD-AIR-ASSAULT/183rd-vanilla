...
class CfgVehicles {
    ...
    class GVAR(resupply): NATO_Box_Base {
        ...
        class SimpleObject {
            ...
            init="[this,10,true,true] call OETAV_fnc_AmmoCrate;";
        };
        ...
        hiddenSelectionsTextures[]= {
            "z\oetav\addons\Equipment\data\ammobox_signs_ca_183.paa",
            "z\oetav\addons\Equipment\data\ammo183_co.paa",
        };
    ...
    class GVAR(arsenal): NATO_Box_Base {
        ...
        _generalMacro="Box_NATO_AmmoVeh_F";
        hiddenSelectionsTextures[]= {
            "z\oetav\addons\Equipment\data\ammobox_signs_caA_183.paa",
            "z\oetav\addons\Equipment\data\ammo183A_co.paa"
        };
        class TransportMagazines {
        };
        class TransportWeapons {
...
/*
    class GVAR(arsenalw): NATO_Box_Base {
        ...
        _generalMacro="Box_NATO_AmmoVeh_F";
        hiddenSelectionsTextures[]= {
            "z\oetav\addons\Equipment\data\ammobox_signs_ca_oetav_A.paa",
            "z\oetav\addons\Equipment\data\ammo_oetav_A_co_winter.paa"
        };
        class TransportMagazines {
        };
        class TransportWeapons {
 ...
 */
   /*  class GVAR(arsenali): NATO_Box_Base {
        ...
        _generalMacro="Box_NATO_AmmoVeh_F";
        hiddenSelectionsTextures[]= {
            "z\oetav\addons\Equipment\data\oetavbox_signs_ca.paa",
            "z\oetav\addons\Equipment\data\ammooetavCA_co.paa"
        };
        class TransportMagazines {
        };
        class TransportWeapons {
