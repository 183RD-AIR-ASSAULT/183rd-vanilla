class RscDisplayCueCard {
    ...
    scriptPath = "OETAVDisplays";
    onLoad = "[""onLoad"",_this,""RscDisplayCueCard"",'OETAVDisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onUnload = "[""onUnload"",_this,""RscDisplayCueCard"",'OETAVDisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    movingEnable = true;
    ...
    class controlsBackground {
        class NotePadBackground: RscPicture {
            idc = 1200;
            text = "z\oetav\addons\common\images\cuecards\notepad_CA.paa";
            x = 0.288594 * safezoneW + safezoneX;
            y = 0.093 * safezoneH + safezoneY;
            w = 0.31 * safezoneW;
            h = 0.754 * safezoneH;
