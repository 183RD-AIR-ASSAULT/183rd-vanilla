class RscNotepad {
    ...
    onLoad = "[""onLoad"",_this,""RscNotepad"",'OETAVDisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onUnload = "[""onUnload"",_this,""RscNotepad"",'OETAVDisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onMouseButtonDown = "\
