...
def main():
    ...
    print("""
  ######################################
  # oetav Development Environment Setup #
  ######################################

  This script will create your oetav dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your oetav project folder:
    [Arma 3 installation directory]\\{} => oetav project folder
    P:\\{}                              => oetav project folder
